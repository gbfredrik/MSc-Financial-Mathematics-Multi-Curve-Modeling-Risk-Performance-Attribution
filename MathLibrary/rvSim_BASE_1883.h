...
public:
	...
	static boost::numeric::ublas::matrix<double> genEps(boost::numeric::ublas::matrix<double> V, boost::numeric::ublas::matrix<double> E, boost::numeric::ublas::vector<double> sigma, std::string type);
};
