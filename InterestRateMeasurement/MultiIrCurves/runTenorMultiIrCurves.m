...
for k=252%length(times)
    ...
    zAll = [zAll; [z; 100*ones(75 - length(z),1)]'];
...
% USD_OS
% fAll(2055,3291:3654) = fAll(2055,3290);
% piAll(2055,3291:3654) = piAll(2055,3290);
% fDatesAll(2055,3292:3655) = fDatesAll(2055+1,3292:3655) - 1;
% TAll(2055,3292:3655) = TAll(2055+1,3292:3655);
%
% fAll(2060,3291:3654) = fAll(2060,3290);
% piAll(2060,3291:3654) = piAll(2060,3290);
% fDatesAll(2060,3292:3655) = fDatesAll(2060+1,3292:3655) - 1;
% TAll(2060,3292:3655) = TAll(2060+1,3292:3655);
