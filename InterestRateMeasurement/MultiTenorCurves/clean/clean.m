%% Read data
dirtyData = xlsread('../measurement/USD.xlsx', 'ASKDIRTY', "B2:AU2220");
dirtyDataAdditional = xlsread('../measurement/USD.xlsx', 'askAdditional', "B2:AU2480");
cleanPeriodDates = table2array(readtable('../measurement/USD.xlsx', 'Sheet', 'ASKDIRTY', 'Range', "A1:A2220"));
%cleanPeriodDates = cleanPeriodDates(2:end);
additionalPeriodDates = table2array(readtable('../measurement/USD.xlsx', 'Sheet', 'askAdditional', 'Range', "A1:A2480"));
...
%% Write Data
xlswrite('../measurement/USD.xlsx', dirtyData, 'ASKOOS', "B2:AU2220")
